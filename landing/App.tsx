...
const App = () => {
  ...
  // URL de Produção do App (CORRIGIDO)
  const APP_URL = 'https://app.yuanbr.com.br';
        ...
        <div className="container mx-auto px-4 lg:px-6 py-4 flex flex-wrap items-center justify-between gap-y-3">
          ...
          <div className="flex items-center gap-2 md:gap-4 w-full md:w-auto justify-end">
            ...
            <div className="flex gap-2">
              <a 
                href={`${APP_URL}/login?role=supplier`}
                className="px-3 py-2 md:px-5 md:py-2.5 text-xs md:text-sm font-bold text-gray-700 hover:text-brand-red transition-colors border border-gray-200 rounded-lg hover:border-brand-red hover:bg-red-50 active:scale-95 text-center flex items-center"
              >
                {text.nav.supplierLogin}
              </a>
              <a 
                href={`${APP_URL}/login?role=client`}
                className="px-3 py-2 md:px-5 md:py-2.5 bg-brand-dark text-white text-xs md:text-sm font-bold rounded-lg hover:bg-brand-red transition-all shadow-lg hover:shadow-brand-red/40 transform hover:-translate-y-0.5 active:translate-y-0 text-center flex items-center"
              >
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left order-2 lg:order-1 animate-fade-in-up">
              ...
              <a 
                href={`${APP_URL}/register?role=client`}
